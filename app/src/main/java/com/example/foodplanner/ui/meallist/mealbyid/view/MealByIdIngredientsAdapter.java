...
public class MealByIdIngredientsAdapter extends RecyclerView.Adapter<MealByIdIngredientsAdapter.ViewHolder> {
    List<IngredientWithMeasure> ingredientWithMeasures;

    public MealByIdIngredientsAdapter(List<IngredientWithMeasure> list) {
        ingredientWithMeasures = list;
    }

    @NonNull
    @Override
    public MealByIdIngredientsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ingredients_item_meal_details, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MealByIdIngredientsAdapter.ViewHolder holder, int position) {
